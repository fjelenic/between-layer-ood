...
#         anchor_emb = model.get_encoded(
#             X_anchor, batch_size=batch_size
#         )  # (batch_size, embeding_size)
#         eval_emb = model.get_encoded(
#             X_eval, batch_size=batch_size
#         )  # (batch_size, embeding_size)
...
#         reprs_orig = model_orig.get_encoded_layers(
#             X_eval
#         )  # (num_layers (12), batch_size, embeding_size)
#         reprs = model.get_encoded_layers(
#             X_eval
#         )  # (num_layers (12), batch_size, embeding_size)

#         return np.linalg.norm(
#             (reprs_orig - reprs).cpu().detach().numpy(), ord=2, axis=-1
#         )  # (num_layers (12), batch_size)
